...
// epochTolerance: ±3 steps = ±210s. TEMPORARY widening for CDMX onsite enrollment
// 2026-06-22 (drifted doctor phones lock out at the venue). REVERT to 2 (±150s) after
// the event. NEVER tighten to 0 (Pitfall 5).
