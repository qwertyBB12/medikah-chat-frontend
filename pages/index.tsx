        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: 'Medikah is a HIPAA-compliant healthcare coordination platform connecting patients in the US and Mexico with licensed physicians via secure telehealth consultations.',
              foundingDate: '2022',
              areaServed: 'Americas',
              medicalSpecialty: 'International Healthcare Coordination',
              contactPoint: {
                '@type': 'ContactPoint',
