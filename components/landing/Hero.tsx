    ...
    >
      ...
      <div className="relative z-[2] max-w-[1000px] px-[clamp(1.5rem,6vw,6rem)]">
        ...
        <h1 className="font-heading font-medium uppercase leading-[0.9] tracking-[-0.02em]">
          ...
          <span className="block text-teal-300 text-[clamp(3.5rem,12vw,10rem)]">
            {t.line2[locale]}
          </span>
        </h1>
        ...
        <div className="flex gap-5 justify-center mt-[clamp(2rem,4vh,3.5rem)] flex-col sm:flex-row items-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 font-body text-[0.8125rem] font-medium uppercase tracking-[0.04em] px-9 py-3.5 bg-transparent text-white border-2 border-white/30 rounded-sm hover:border-teal-400 hover:text-teal-300 hover:-translate-y-[3px] transition-all duration-300"
          >
        ...
        <div className="flex gap-6 justify-center items-center mt-[clamp(2.5rem,5vh,4rem)] flex-wrap">
          {['HIPAA Compliant', 'Bilingual EN/ES', 'Cross-Border'].map((badge) => (
            <span key={badge} className="flex items-center gap-2 font-body text-[0.6875rem] font-medium uppercase tracking-[0.04em] text-cream-500">
