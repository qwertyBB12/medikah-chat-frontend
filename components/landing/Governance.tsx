const PILLARS = [
  {
    icon: (
      <svg className="w-8 h-8 text-inst-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  return (
    <section className="bg-steady-teal px-6 py-24 sm:py-32">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-deep-charcoal leading-relaxed text-center max-w-[800px] mx-auto mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          {PILLARS.map((pillar) => (
            <div key={pillar.label} className="flex flex-col items-center text-center gap-3">
              ...
              <p className="font-bold text-sm tracking-wide text-inst-blue">
                {pillar.label}
              </p>
            </div>
          ))}
