/**
 * UsLegacyTerms — the United States Terms of Service body as it stood BEFORE
 * counsel Luis Ignacio's 2026-04-16 finals. Restored at the founder's direction
 * (2026-06-29): the new EN/US finals framed cross-border as the "primary
 * service", which mischaracterizes the model — so US visitors see this prior
 * copy until counsel redlines the EN/US finals. Mexico keeps the new counsel
 * terms (see pages/terms.tsx). Verbatim from git 21b9f9a:pages/terms.tsx.
 */
import Link from 'next/link';

export default function UsLegacyTerms() {
  return (
    <>
          ...
          <div className="prose-medikah">
            ...
            <ul>
              ...
              <li>Immediately notifying us of unauthorized access: <a href="mailto:support@medikah.health">support@medikah.health</a></li>
            ...
            <p><strong>If a provider violates restrictions:</strong> Report immediately to <a href="mailto:legal@medikah.health">legal@medikah.health</a>.</p>
            ...
            <p>If a provider violates cross-border restrictions: stop the consultation, document what happened, and report to <a href="mailto:legal@medikah.health">legal@medikah.health</a> with &ldquo;Provider Violation Report&rdquo; in the subject line. No retaliation for good-faith reports.</p>
            ...
            <p>Before filing any legal claim, you agree to contact us at <a href="mailto:legal@medikah.health">legal@medikah.health</a>, describe your concern in detail, and provide opportunity for us to resolve within 60 days.</p>
            ...
            <p><strong>Right to Opt-Out:</strong> You may opt out of arbitration by emailing <a href="mailto:legal@medikah.health">legal@medikah.health</a> within 30 days of accepting these Terms with &ldquo;Arbitration Opt-Out&rdquo; in the subject line.</p>
            ...
            <p>You may terminate your account at any time by closing it in Account Settings or emailing <a href="mailto:support@medikah.health">support@medikah.health</a>. Platform access ends immediately. We retain records per legal requirements. Outstanding payment obligations remain. Data available for download for 90 days.</p>
            ...
            <ul>
              <li>Legal notices: <a href="mailto:legal@medikah.health">legal@medikah.health</a></li>
              <li>Support: <a href="mailto:support@medikah.health">support@medikah.health</a></li>
              <li>Privacy: <a href="mailto:privacy@medikah.health">privacy@medikah.health</a></li>
            </ul>
            ...
            <p><strong>Email:</strong> <a href="mailto:support@medikah.health">support@medikah.health</a><br /><strong>Response Time:</strong> Within 2 business days</p>

            <h3>Legal Department</h3>
            <p><strong>Email:</strong> <a href="mailto:legal@medikah.health">legal@medikah.health</a></p>

            <h3>Privacy Requests</h3>
            <p><strong>Email:</strong> <a href="mailto:privacy@medikah.health">privacy@medikah.health</a></p>
