...
export const THEMES: Record<ThemeKey, ThemeSettings> = {
  warm: {
    ...
    userTextClass: 'text-[#3f2a28]',
    botTextClass: 'text-[#1b1c1d]',
    primaryButton: 'bg-[#1a7c8b] text-white hover:bg-[#166776]',
    chatInputBackground: 'bg-[#c47f7c]/85',
    chatInputSurface: 'bg-white/95 text-[#1b1c1d]',
  ...
  ocean: {
    ...
    userBubble: 'bg-[#176874] rounded-none shadow',
    botBubble: 'bg-[#104d56] rounded-none shadow',
    userTextClass: 'text-white',
    botTextClass: 'text-white',
    primaryButton: 'bg-white/85 text-[#104a53] hover:bg-white',
    chatInputBackground: 'bg-[#165f6b]',
    chatInputSurface: 'bg-[#1b6f7c] text-white border border-white/15',
    guidanceText: 'text-white/85',
