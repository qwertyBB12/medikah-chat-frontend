...
• I know how to contact Medikah if I have concerns: support@medikah.com
• I know how to report problems or violations: legal@medikah.com

I UNDERSTAND that I can contact:
• Medikah Support: support@medikah.com (platform and account questions)
• Medikah Legal: legal@medikah.com (violations or legal concerns)
• Medikah Privacy: privacy@medikah.com (privacy and data questions)`,
    },
  ],
  es: [
    {
...
• Sé cómo contactar a Medikah si tengo inquietudes: support@medikah.com
• Sé cómo reportar problemas o violaciones: legal@medikah.com

ENTIENDO que puedo contactar:
• Soporte de Medikah: support@medikah.com (preguntas sobre la plataforma y cuenta)
• Legal de Medikah: legal@medikah.com (violaciones o inquietudes legales)
• Privacidad de Medikah: privacy@medikah.com (preguntas sobre privacidad y datos)`,
    },
  ],
};
